...
public class CategoryControllerTests {
    ...
    @Test
    public void testGetBudgetSummary() throws Exception {
    ...
    @Test
    public void testAddCategory_NullBody() throws Exception {
    ...
    @Test
    public void testGetBudgetSummary_Empty() throws Exception {
...
@Test
public void testGetAllCategories_SingleCategory() throws Exception {
...
@Test
public void testGetBudgetSummary_WithZeroSpent() throws Exception {
...
@Test
public void testAddCategory_EmptyJson() throws Exception {
    mockMvc.perform(post("/api/categories")
            .contentType(MediaType.APPLICATION_JSON)
            .content("{}"))
...
@Test
public void testDeleteCategory_NoIdProvided() throws Exception {
